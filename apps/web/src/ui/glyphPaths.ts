...
// Run `npm run gen:glyphs` to regenerate from src/ui/glyphs.ts.
...
export const GLYPH_PATHS: Record<GlyphId, string> = {
  ...
  SHIELD: 'M0 1h8v1h-8zM0 2h3v1h-3zM5 2h3v1h-3zM0 3h2v1h-2zM6 3h2v1h-2zM1 4h1v1h-1zM6 4h1v1h-1zM1 5h2v1h-2zM5 5h2v1h-2zM2 6h4v1h-4zM3 7h2v1h-2z',
