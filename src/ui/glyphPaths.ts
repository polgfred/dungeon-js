...
export const GLYPH_PATHS: Record<GlyphId, string> = {
  ...
  VENDOR: 'M3 0h2v1h-2zM1 1h6v1h-6zM0 2h2v1h-2zM3 2h2v1h-2zM0 3h2v1h-2zM3 3h4v1h-4zM1 4h4v1h-4zM6 4h2v1h-2zM3 5h2v1h-2zM6 5h2v1h-2zM1 6h6v1h-6zM3 7h2v1h-2z',
